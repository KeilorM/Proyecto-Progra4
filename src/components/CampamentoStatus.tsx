...
function calcularNivel(m: Metricas): Nivel {
  ...
  const niveles = [
    { nivel: 1, nombre: "REFUGIO",      color: "#94a3b8", icono: "⛺", descripcion: "Apenas sobreviviendo",   xpMax: 100 },
    { nivel: 2, nombre: "ASENTAMIENTO", color: "#60a5fa", icono: "🏕️", descripcion: "Organización básica",    xpMax: 250 },
    { nivel: 3, nombre: "FORTALEZA",    color: "#facc15", icono: "🏰", descripcion: "Base consolidada",        xpMax: 500 },
    { nivel: 4, nombre: "BASTIÓN",      color: "#10b981", icono: "🛡️", descripcion: "Resistencia total",       xpMax: 999 },
  ]
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            <div style={{ position: "relative", width: 80, height: 80, flexShrink: 0 }}>
              <svg viewBox="0 0 80 80" style={{ transform: "rotate(-90deg)", width: 80, height: 80 }}>
                <circle cx="40" cy="40" r="34" fill="none" stroke="rgba(30,41,59,0.8)" strokeWidth="8" />
                <circle
                  cx="40" cy="40" r="34"
                  fill="none"
                  stroke={saludColor}
                  ...
                  strokeLinecap="round"
                  style={{ transition: "stroke-dashoffset 1s ease", filter: `drop-shadow(0 0 4px ${saludColor})` }}
                />
              </svg>
              <div style={{
                position: "absolute",
            ...
            <div style={{ flex: 1 }}>
              {[
                { label: "Sanos",   value: metricas.personas.por_estado["SANO"]    ?? 0, color: "#4ade80" },
                { label: "Heridos", value: metricas.personas.por_estado["HERIDO"]  ?? 0, color: "#fb923c" },
                { label: "Enfermos",value: metricas.personas.por_estado["ENFERMO"] ?? 0, color: "#facc15" },
              ].map(item => (
