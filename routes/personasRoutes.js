...
import { uploadPersona } from "../middleware/upload.js"; // ← nuevo
import {
  getPersonas, 
  addPersona, 
  updateEstadoPersona,
...
router.post("/",          verifyToken, verifyRol("ADMIN"), uploadPersona, addPersona); // ← uploadPersona antes del controller
